...
public class CharInfo implements IClientOutgoingPacket
{
	...
	private final int _vehicleId = 0;
	...
	public boolean write(PacketWriter packet)
	{
		...
		packet.writeD(_player.getVisualClassId() < 0 ? _player.getBaseTemplate().getClassId().getRootClassId().getId() : _player.getVisualClassId());// 종족 외형변경
