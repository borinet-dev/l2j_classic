...
public class ExFriendDetailInfo implements IClientOutgoingPacket
{
	...
	public ExFriendDetailInfo(Player player, String name)
	{
		...
		_lastAccess = (_friend == null) || _friend.isBlocked(player) ? 0 : _friend.isOnline() ? 0 : (int) (System.currentTimeMillis() - _friend.getLastAccess()) / 1000;
	}
	...
	public boolean write(PacketWriter packet)
	{
		...
		else
		{
			...
			packet.writeS(CharInfoTable.getInstance().getFriendMemo(_objectId, _friend.getObjectId())); // memo
		}
		return true;
	}
}
