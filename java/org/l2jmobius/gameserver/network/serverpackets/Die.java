...
public class Die implements IClientOutgoingPacket
{
	...
	public Die(Creature creature)
	{
		...
		if (creature.isPlayer())
		{
			...
			_useFeather = (!player.isInSiege() && !player.isInsideZone(ZoneId.SIEGE) && !player.isInsideZone(ZoneId.PVP)) && (creature.getAccessLevel().allowFixedRes() || BorinetUtil.SelfResurrectBuff(player) || creature.getInventory().haveItemForSelfResurrection());
