...
public class CombinationItemsData implements IXmlReader
{
	...
	{
		_items.clear();
		parseDatapackFile((BorinetTask.SpecialEvent() || BorinetUtil._WendEventStarted || BorinetTask.MemorialDayCheck()) ? "data/CombinationItemsEvent.xml" : "data/CombinationItems.xml");
