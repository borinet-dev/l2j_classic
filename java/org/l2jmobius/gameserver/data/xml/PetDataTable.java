...
public class PetDataTable implements IXmlReader
{
	...
	public final static int ROSE_DESELOPH_ID = 1568;
	public final static int ROSE_HYUM_ID = 1569;
	public final static int ROSE_REKANG_ID = 1570;
	public final static int ROSE_LILIAS_ID = 1571;
	public final static int ROSE_LAPHAM_ID = 1572;
	public final static int ROSE_MAPHUM_ID = 1573;
	...
	public static boolean isRosePet(int id)
	{
		switch (id)
		{
