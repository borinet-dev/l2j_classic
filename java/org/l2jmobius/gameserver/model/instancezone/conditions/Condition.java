...
public abstract class Condition
{
	...
	private BiConsumer<SystemMessage, Player> _sendMsgParams = null;
	...
	private void sendMessage(List<Player> group, Player member, BiConsumer<Player, String> htmlCallback)
	{
		...
		if (_sendMsg != null)
		{
			final SystemMessage msg = new SystemMessage(_sendMsg);
			if (_sendMsgParams != null)
			{
				_sendMsgParams.accept(msg, member);
			}
	...
	protected void sendMessage(String msg, BiConsumer<SystemMessage, Player> params)
	{
		sendMessage(msg);
		_sendMsgParams = params;
	}
