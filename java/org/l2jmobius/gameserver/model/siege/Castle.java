...
public class Castle extends AbstractResidence
{
	...
	{
		setTaxPercents(taxPercent);
	}
	
	public void setTaxPercents(int p)
	{
	...
	public void giveResidentialSkills(Player player)
	{
		...
		switch (clan.getCastleId())
		{
			case 3:
			{
				player.addSkill(CommonSkill.GIRAN_SKILL.getSkill());
				break;
			}
			case 5:
			{
				player.addSkill(CommonSkill.ADEN_SKILL.getSkill());
				break;
			}
		}
	}
	...
	public void removeResidentialSkills(Player player)
	{
		...
		player.removeSkill(CommonSkill.GIRAN_SKILL.getId());
		player.removeSkill(CommonSkill.ADEN_SKILL.getId());
	}
