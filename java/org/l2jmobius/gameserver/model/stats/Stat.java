...
public enum Stat
{
	...
	PARALYZE_RESIST("paralyzeResist"),
	TURN_STONE_RESIST("turnstoneResist"),
	DERANGEMENT_RESIST("derangementResist"),
	STUN_RESIST("stunResist"),
	HOLD_RESIST("holdResist"),
	SLEEP_RESIST("sleepResist"),
	BLEED_RESIST("bleedResist"),
	POISON_RESIST("poisonResist"),
	SILENCE_RESIST("silenceResist"),
	
	// 무기 저항
	SWORD_RESIST("swordResist"),
	BIGSWORD_RESIST("bigswordResist"),
	DUAL_RESIST("dualResist"),
	DAGGER_RESIST("daggerResist"),
	BLUNT_RESIST("bluntResist"),
	DUALFIST_RESIST("dualfistResist"),
	POLE_RESIST("poleResist"),
	BOW_RESIST("bowResist"),
	MAGIC_DAM_RESIST("MDamResist"),
