...
public class ClanMember
{
	...
	public ClanMember(Clan clan, Player player)
	{
		...
		_raceOrdinal = player.getOriginRace().ordinal();
	}
	...
	public void setPlayer(Player player)
	{
		if ((player == null) && (_player != null))
		{
			...
			_raceOrdinal = _player.getOriginRace().ordinal();
		}
	...
	{
		return _player != null ? _player.getOriginRace().ordinal() : _raceOrdinal;
	}
	...
	{
		return _player != null ? _player.getAccountVariables() : new AccountVariables(_player.getAccountName());
	}
