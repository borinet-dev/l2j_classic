...
{
	// 컬렉터 능력치 증가 메서드
	private int _bonusPAtk = 0;
	private int _bonusPDef = 0;
	private int _bonusMAtk = 0;
	private int _bonusMDef = 0;
	private int _bonusPAccuracy = 0;
	private int _bonusMAccuracy = 0;
	
	public int _bonusCPatk = 0;
	private int _bonusPSkillCrtDmg = 0;
	private int _bonusMCrtDmg = 0;
	private int _bonusPCrtChance = 0;
	private int _bonusMCrtChance = 0;
	
	private int _bonusParalyzeResist = 0;
	private int _bonusTurnstoneResist = 0;
	private int _bonusDerangementResist = 0;
	private int _bonusStunResist = 0;
	private int _bonusHoldResist = 0;
	private int _bonusSleepResist = 0;
	private int _bonusBleedResist = 0;
	private int _bonusPoisonResist = 0;
	private int _bonusSilenceResist = 0;
	
	private int _bonusHP = 0;
	private int _bonusMP = 0;
	private int _bonusCP = 0;
	private int _bonusMpRegen = 0;
	
	private int _bonusRusSpd = 0;
	private int _bonusPeVas = 0;
	private int _bonusMeVas = 0;
	
	private int _bonusFireRes = 0;
	private int _bonusWindRes = 0;
	private int _bonusWaterRes = 0;
	private int _bonusEarthRes = 0;
	private int _bonusHolyRes = 0;
	private int _bonusDarkRes = 0;
	private int _bonusFirePower = 0;
	private int _bonusWindPower = 0;
	private int _bonusWaterPower = 0;
	private int _bonusEarthPower = 0;
	private int _bonusHolyPower = 0;
	private int _bonusDarkPower = 0;
	...
	{
		return (int) getValue(Stat.ACCURACY_COMBAT) + _bonusPAccuracy;
	}
	...
	{
		return (int) getValue(Stat.PARALYZE_RESIST) + _bonusParalyzeResist;
	}
	
	public int getTurnStoneResist()
	{
		return (int) getValue(Stat.TURN_STONE_RESIST) + _bonusTurnstoneResist;
	}
	
	public int getDerangementResist()
	{
		return (int) getValue(Stat.DERANGEMENT_RESIST) + _bonusDerangementResist;
	}
	
	public int getStunResist()
	{
		return (int) getValue(Stat.STUN_RESIST) + _bonusStunResist;
	}
	
	public int getHoldResist()
	{
		return (int) getValue(Stat.HOLD_RESIST) + _bonusHoldResist;
	}
	
	public int getSleepResist()
	{
		return (int) getValue(Stat.SLEEP_RESIST) + _bonusSleepResist;
	}
	
	public int getBleedResist()
	{
		return (int) getValue(Stat.BLEED_RESIST) + _bonusBleedResist;
	}
	
	public int getPoisonResist()
	{
		return (int) getValue(Stat.POISON_RESIST) + _bonusPoisonResist;
	}
	
	public int getSilenceResist()
	{
		return (int) getValue(Stat.SILENCE_RESIST) + _bonusSilenceResist;
	}
	
	// 무기 저항
	public int getSwordResist()
	{
		return (int) getValue(Stat.SWORD_RESIST);
	}
	
	public int getBigSwordResist()
	{
		return (int) getValue(Stat.BIGSWORD_RESIST);
	}
	
	public int getDualResist()
	{
		return (int) getValue(Stat.DUAL_RESIST);
	}
	
	public int getDaggerResist()
	{
		return (int) getValue(Stat.DAGGER_RESIST);
	}
	
	public int getBluntResist()
	{
		return (int) getValue(Stat.BLUNT_RESIST);
	}
	
	public int getDualFistResist()
	{
		return (int) getValue(Stat.DUALFIST_RESIST);
	}
	
	public int getPoleResist()
	{
		return (int) getValue(Stat.POLE_RESIST);
	}
	
	public int getBowResist()
	{
		return (int) getValue(Stat.BOW_RESIST);
	}
	
	public int getMDamResist()
	{
		return (int) getValue(Stat.MAGIC_DAM_RESIST);
	}
	...
	{
		return (int) getValue(Stat.ACCURACY_MAGIC) + _bonusMAccuracy;
	}
	...
	{
		return (int) getValue(Stat.EVASION_RATE) + _bonusPeVas;
	}
	...
	{
		return (int) getValue(Stat.MAGIC_EVASION_RATE) + _bonusMeVas;
	}
	...
	public int getMaxCp()
	{
		return (int) getValue(Stat.MAX_CP) + _bonusCP;
	}
	...
	public int getMaxHp()
	{
		return (int) getValue(Stat.MAX_HP) + _bonusHP;
	}
	...
	public int getMaxMp()
	{
		return (int) getValue(Stat.MAX_MP) + _bonusMP;
	}
	...
	public int getMAtk()
	{
		return (int) getValue(Stat.MAGIC_ATTACK) + _bonusMAtk;
	}
	...
	{
		return (int) getValue(Stat.MAGIC_CRITICAL_RATE) + _bonusMCrtChance;
	}
	...
	public int getMDef()
	{
		return (int) getValue(Stat.MAGICAL_DEFENCE) + _bonusMDef;
	}
	...
	{
		return getValue(_creature.isInsideZone(ZoneId.WATER) ? Stat.SWIM_RUN_SPEED : Stat.RUN_SPEED) + _bonusRusSpd;
	}
	...
	{
		_bonusWaterRes += value;
	}
	
	public void addResistEarth(int value)
	{
		_bonusEarthRes += value;
	}
	...
	public int getPSkillCrtDmg()
	{
		return _bonusPSkillCrtDmg;
	}
	
	public int getPCrtDmg()
	{
		return _bonusCPatk;
	}
	
	public int getMCrtDmg()
	{
		return _bonusMCrtDmg;
	}
	
	public int getRegenMp()
	{
		return _bonusMpRegen;
	}
	
	public int getPCrtChance()
	{
		return _bonusPCrtChance;
	}
	// 컬렉터 능력치 증가 메서드
	...
	public int getPAtk()
	{
		return (int) getValue(Stat.PHYSICAL_ATTACK) + _bonusPAtk;
	}
	...
	public int getPDef()
	{
		return (int) getValue(Stat.PHYSICAL_DEFENCE) + _bonusPDef;
	}
	...
	public int getAttackElementValue(AttributeType attackAttribute)
	{
		switch (attackAttribute)
		{
			case FIRE:
			{
				return (int) getValue(Stat.FIRE_POWER) + _bonusFirePower;
			}
			case WATER:
			{
				return (int) getValue(Stat.WATER_POWER) + _bonusWaterPower;
			}
			case WIND:
			{
				return (int) getValue(Stat.WIND_POWER) + _bonusWindPower;
			}
			case EARTH:
			{
				return (int) getValue(Stat.EARTH_POWER) + _bonusEarthPower;
			}
			case HOLY:
			{
				return (int) getValue(Stat.HOLY_POWER) + _bonusHolyPower;
			}
			case DARK:
			{
				return (int) getValue(Stat.DARK_POWER) + _bonusDarkPower;
			}
			default:
			{
				return 0;
	...
	public int getDefenseElementValue(AttributeType defenseAttribute)
	{
		switch (defenseAttribute)
		{
			case FIRE:
			{
				return (int) getValue(Stat.FIRE_RES) + _bonusFireRes;
			}
			case WATER:
			{
				return (int) getValue(Stat.WATER_RES) + _bonusWaterRes;
			}
			case WIND:
			{
				return (int) getValue(Stat.WIND_RES) + _bonusWindRes;
			}
			case EARTH:
			{
				return (int) getValue(Stat.EARTH_RES) + _bonusEarthRes;
			}
			case HOLY:
			{
				return (int) getValue(Stat.HOLY_RES) + _bonusHolyRes;
			}
			case DARK:
			{
				return (int) getValue(Stat.DARK_RES) + _bonusDarkRes;
			}
			default:
			{
