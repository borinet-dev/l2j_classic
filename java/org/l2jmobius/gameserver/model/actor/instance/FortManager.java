				...
				if (player.hasClanPrivilege(ClanPrivilege.CS_SET_FUNCTIONS))
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						...
						if (getFort().getFortFunction(Fort.FUNC_RESTORE_HP) != null)
						{
							...
							html.replace("%hp_period%", "Withdraw the fee for the next time at " + BorinetUtil.dataDateFormatKor.format(getFort().getFortFunction(Fort.FUNC_RESTORE_HP).getEndTime()));
						...
						if (getFort().getFortFunction(Fort.FUNC_RESTORE_EXP) != null)
						{
							...
							html.replace("%exp_period%", "Withdraw the fee for the next time at " + BorinetUtil.dataDateFormatKor.format(getFort().getFortFunction(Fort.FUNC_RESTORE_EXP).getEndTime()));
						...
						if (getFort().getFortFunction(Fort.FUNC_RESTORE_MP) != null)
						{
							...
							html.replace("%mp_period%", "Withdraw the fee for the next time at " + BorinetUtil.dataDateFormatKor.format(getFort().getFortFunction(Fort.FUNC_RESTORE_MP).getEndTime()));
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						if (getFort().getFortFunction(Fort.FUNC_TELEPORT) != null)
						{
							...
							html.replace("%tele_period%", "Withdraw the fee for the next time at " + BorinetUtil.dataDateFormatKor.format(getFort().getFortFunction(Fort.FUNC_TELEPORT).getEndTime()));
						...
						if (getFort().getFortFunction(Fort.FUNC_SUPPORT) != null)
						{
							...
							html.replace("%support_period%", "Withdraw the fee for the next time at " + BorinetUtil.dataDateFormatKor.format(getFort().getFortFunction(Fort.FUNC_SUPPORT).getEndTime()));
