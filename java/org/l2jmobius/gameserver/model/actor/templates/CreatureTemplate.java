...
public class CreatureTemplate extends ListenersContainer
{
	...
	{
		int subStat = Config.CHARACTER_BASE_STAT_SUB;
		// Base stats
		_baseValues.put(Stat.STAT_STR, (set.getDouble("baseSTR", 0) - subStat));
		_baseValues.put(Stat.STAT_CON, (set.getDouble("baseCON", 0) - subStat));
		_baseValues.put(Stat.STAT_DEX, (set.getDouble("baseDEX", 0) - subStat));
		_baseValues.put(Stat.STAT_INT, (set.getDouble("baseINT", 0) - subStat));
		_baseValues.put(Stat.STAT_WIT, (set.getDouble("baseWIT", 0) - subStat));
		_baseValues.put(Stat.STAT_MEN, (set.getDouble("baseMEN", 0) - subStat));
		...
		// Attack speed
		_baseValues.put(Stat.PHYSICAL_ATTACK_SPEED, set.getDouble("basePAtkSpd", 290));
		_baseValues.put(Stat.MAGIC_ATTACK_SPEED, set.getDouble("baseMAtkSpd", 300));
		...
		// Accurancy.
		_baseValues.put(Stat.ACCURACY_COMBAT, set.getDouble("accuracy", 5));
		_baseValues.put(Stat.ACCURACY_MAGIC, set.getDouble("accuracy", 5));
		_baseValues.put(Stat.ATK_REUSE, set.getDouble("reuseDelay", 0));
		_baseValues.put(Stat.EVASION_RATE, set.getDouble("evasion", 3));
		_baseValues.put(Stat.MAGIC_EVASION_RATE, set.getDouble("evasion", 3));
		...
		// Speed
		_baseValues.put(Stat.RUN_SPEED, set.getDouble("baseRunSpd", 110));
	...
	/**
	 * @return the baseAccCombat
	 */
	public int getBaseAccCombat()
	{
		final Double val = _baseValues.get(Stat.ACCURACY_COMBAT);
		return val != null ? val.intValue() : 0;
	}
	
	/**
	 * @return the baseAccMagic
	 */
	public int getBaseAccMagic()
	{
		final Double val = _baseValues.get(Stat.ACCURACY_MAGIC);
		return val != null ? val.intValue() : 0;
	}
	
	/**
	 * @return the baseEvasion
	 */
	public int getBaseEvasion()
	{
		final Double val = _baseValues.get(Stat.EVASION_RATE);
		return val != null ? val.intValue() : 0;
	}
	
	/**
	 * @return the baseEvasionMagic
	 */
	public int getBaseEvasionMagic()
	{
		final Double val = _baseValues.get(Stat.MAGIC_EVASION_RATE);
		return val != null ? val.intValue() : 0;
	}
	...
	/**
	 * @return the baseRunSpk
	 */
	public int getBaseRunSpk()
	{
		final Double val = _baseValues.get(Stat.RUN_SPEED);
		return val != null ? val.intValue() : 0;
	}
