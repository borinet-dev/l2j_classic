...
{
	public static final Logger LOGGER = Logger.getLogger(WorldObject.class.getName());
	/** Name */
	...
	public final boolean isInRangeZ(WorldObject obj, long range)
	{
		if (obj == null)
		{
			return false;
	...
	private boolean isSettingXYZ = false;
