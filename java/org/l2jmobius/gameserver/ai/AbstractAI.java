...
public abstract class AbstractAI implements Ctrl
{
	...
	public final void setIntention(CtrlIntention intention, Object... args)
	{
		...
		switch (intention)
		{
			...
			case AI_AUTO_FOLLOW:
			{
				onIntentionAutoFollow((Creature) args[0]);
				break;
			}
		}
	...
	protected abstract void onIntentionAutoFollow(Creature target);
	...
	public synchronized void startAutoFollow(Creature target, int range)
	{
		stopFollow();
		setTarget(target);
		CreatureFollowTaskManager.getInstance().addAutoFollow(_actor, range);
	}
