...
public class HtmlUtil
{
	...
	public static String getHpGaugeStat(int width, long current, long max, boolean displayAsPercentage)
	{
		return getGaugeStat(width, current, max, displayAsPercentage, "L2UI_CT1.Gauges.Gauge_DF_Large_HP_bg_Center", "L2UI_CT1.Gauges.Gauge_DF_Large_HP_Center", 17, -13);
	}
	
	public static String getMpGaugeStat(int width, long current, long max, boolean displayAsPercentage)
	{
		return getGaugeStat(width, current, max, displayAsPercentage, "L2UI_CT1.Gauges.Gauge_DF_Large_MP_bg_Center", "L2UI_CT1.Gauges.Gauge_DF_Large_MP_Center", 17, -13);
	}
	
	private static String getGaugeStat(int width, long currents, long max, boolean displayAsPercentage, String backgroundImage, String image, long imageHeight, long top)
	{
		long current = Math.min(currents, max);
		...
		else
		{
			...
			sb.append("<td width=" + tdWidth + " align=left> /5</td></tr></table>");
		}
		sb.append("</td></tr></table></td></tr></table>");
		return sb.toString();
	}
	
	public static String getHpGaugeSpec(int width, long current, long max, boolean displayAsPercentage)
	{
		return getGaugeSpec(width, current, max, displayAsPercentage, "L2UI_CT1.Gauges.Gauge_DF_Large_HP_bg_Center", "L2UI_CT1.Gauges.Gauge_DF_Large_HP_Center", 17, -13);
	}
	
	public static String getMpGaugeSpec(int width, long current, long max, boolean displayAsPercentage)
	{
		return getGaugeSpec(width, current, max, displayAsPercentage, "L2UI_CT1.Gauges.Gauge_DF_Large_MP_bg_Center", "L2UI_CT1.Gauges.Gauge_DF_Large_MP_Center", 17, -13);
	}
	
	private static String getGaugeSpec(int width, long currents, long max, boolean displayAsPercentage, String backgroundImage, String image, long imageHeight, long top)
	{
		long current = Math.min(currents, max);
		final StringBuilder sb = new StringBuilder();
		sb.append("<table width=" + width + " cellpadding=0 cellspacing=0><tr><td background=\"" + backgroundImage + "\">");
		...
		else
		{
			final String tdWidth = String.valueOf((width - 10) / 2);
			sb.append("<table cellpadding=0 cellspacing=0><tr><td width=" + tdWidth + " align=right>" + String.valueOf(current) + "</td>");
			sb.append("<td width=" + tdWidth + " align=left> %</td></tr></table>");
		}
		sb.append("</td></tr></table></td></tr></table>");
		return sb.toString();
	}
