...
public class Gui
{
	...
	public Gui()
	{
		...
		{
			if (JOptionPane.showOptionDialog(null, "로그인서버를 종료하시겠습니까?", Config.SERVER_NAME_KOR, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, shutdownOptions, shutdownOptions[1]) == 0)
			{
		...
		{
			if (JOptionPane.showOptionDialog(null, "로그인서버를 재시작하시겠습니까?", Config.SERVER_NAME_KOR, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, restartOptions, restartOptions[1]) == 0)
			{
		...
		scrollPanel.setBounds(0, 0, 800, 300);
		
		// Set frame.
		final JFrame frame = new JFrame(Config.SERVER_NAME_KOR + " - LoginServer");
		...
		frame.addWindowListener(new WindowAdapter()
		{
			...
			{
				if (JOptionPane.showOptionDialog(null, "로그인서버를 즉시 종료하시겠습니까?", Config.SERVER_NAME_KOR, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, shutdownOptions, shutdownOptions[1]) == 0)
				{
					LoginServer.getInstance().shutdown(false);
				}
			}
