...
public class frmAbout
{
	...
	private static final String URL = "https://l2wassub.org";
	final URI uri;
	...
	private void initialize()
	{
		...
		final JLabel lblLjmobius = new JLabel("L2j-borinet");
		...
		final JLabel lblData = new JLabel("2008-" + Calendar.getInstance().get(Calendar.YEAR));
