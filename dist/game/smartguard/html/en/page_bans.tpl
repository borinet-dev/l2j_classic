<font color="919191">현재</font> %count% <font color="919191">개의 HWID가 추방상태 입니다.</font>
<table width=275>
    <tr>
        <td><edit var="srch" width=220 height=14></td>
        <td><button value="검색" action="bypass -h admin_sg_bans 0 $srch" width=40 height=19 back="L2UI_ch3.smallbutton2" fore="L2UI_ch3.smallbutton2"></td>
    </tr>
</table>
<br>
<center>
