			...
			case "REMOVE_FIRE_RAGE":
			{
				if (player.isAffectedBySkill(FIRE_RAG_1))
				{
					...
					if (playerFireRage < 5)
					{
						...
						npc.broadcastSay(ChatType.NPC_SHOUT, "축복과 함께하길... 어서 싸움을 끝내세요!");
						break;
					}
					npc.broadcastSay(ChatType.NPC_SHOUT, "제 힘을 사용할 수 없어요.");
					player.sendMessage("프레야: 제 힘을 사용할 수 없어요.");
					break;
				}
				npc.broadcastSay(ChatType.NPC_SHOUT, "파이어 레이지의 영향을 받으면 도와드리겠습니다.");
				break;
			}
