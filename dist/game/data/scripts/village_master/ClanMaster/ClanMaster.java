...
public class ClanMaster extends AbstractNpcAI
{
	...
	public void onPlayerClanLeft(OnPlayerClanLeft event)
	{
		...
		event.getClanMember().getPlayer().getEffectList().stopSkillEffects(SkillFinishType.REMOVED, CommonSkill.NEWBIE_CLAN_ADVENT.getId());
	}
