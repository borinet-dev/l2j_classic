...
public class EffectMasterHandler
{
	...
	public static void main(String[] args)
	{
		...
		EffectHandler.getInstance().registerHandler("AutoItem", AutoItem::new);
		...
		EffectHandler.getInstance().registerHandler("BowAtkReuse", BowAtkReuse::new);
		...
		EffectHandler.getInstance().registerHandler("GiveClanFame", GiveClanFame::new);
		...
		EffectHandler.getInstance().registerHandler("ResistBleed", ResistBleed::new);
		EffectHandler.getInstance().registerHandler("ResistDDMagic", ResistDDMagic::new);
		EffectHandler.getInstance().registerHandler("ResistDerangement", ResistDerangement::new);
		EffectHandler.getInstance().registerHandler("ResistDispelByCategory", ResistDispelByCategory::new);
		EffectHandler.getInstance().registerHandler("ResistHold", ResistHold::new);
		EffectHandler.getInstance().registerHandler("ResistParalyze", ResistParalyze::new);
		EffectHandler.getInstance().registerHandler("ResistPoison", ResistPoison::new);
		EffectHandler.getInstance().registerHandler("ResistSilence", ResistSilence::new);
		EffectHandler.getInstance().registerHandler("ResistSkill", ResistSkill::new);
		EffectHandler.getInstance().registerHandler("ResistSleep", ResistSleep::new);
		EffectHandler.getInstance().registerHandler("ResistStun", ResistStun::new);
		EffectHandler.getInstance().registerHandler("ResistTurnStone", ResistTurnStone::new);
		// 무기 저항
		EffectHandler.getInstance().registerHandler("ResistBigSword", ResistBigSword::new);
		EffectHandler.getInstance().registerHandler("ResistBlunt", ResistBlunt::new);
		EffectHandler.getInstance().registerHandler("ResistBow", ResistBow::new);
		EffectHandler.getInstance().registerHandler("ResistDagger", ResistDagger::new);
		EffectHandler.getInstance().registerHandler("ResistDual", ResistDual::new);
		EffectHandler.getInstance().registerHandler("ResistDualFist", ResistDualFist::new);
		EffectHandler.getInstance().registerHandler("ResistPole", ResistPole::new);
		EffectHandler.getInstance().registerHandler("ResistSword", ResistSword::new);
		EffectHandler.getInstance().registerHandler("ResistMagicDam", ResistMagicDam::new);
		...
		EffectHandler.getInstance().registerHandler("SummonMelon", SummonMelon::new);
		...
		EffectHandler.getInstance().registerHandler("TriggerSkillBySkillCast", TriggerSkillBySkillCast::new);
