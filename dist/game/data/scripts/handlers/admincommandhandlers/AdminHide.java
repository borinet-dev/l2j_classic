		...
		try
		{
			...
			switch (param)
			{
				case "on":
				{
					...
					{
						BuilderUtil.sendSysMessage(player, "현재 투명모드 상태 입니다.");
						return true;
					}
					
					BuilderUtil.sendSysMessage(player, "투명모드로 전환합니다.");
					return true;
				}
				case "off":
				{
					...
					{
						BuilderUtil.sendSysMessage(player, "현재 투명모드가 아닙니다.");
						return true;
					}
					
					BuilderUtil.sendSysMessage(player, "투명모드를 해제합니다.");
					return true;
				}
				default:
				{
