...
public class AdminEnchant implements IAdminCommandHandler
{
	...
	private void setEnchant(Player activeChar, int ench, int armorType)
	{
		...
		if (itemInstance != null)
		{
			...
			// informations
			String itemName = ItemNameTable.getInstance().getItemNameKor(itemInstance.getTemplate().getId());
			BuilderUtil.sendSysMessage(activeChar, "아이템 강화: " + player.getName() + "님의 [" + itemInstance.getTemplate().getName() + "]: " + curEnchant + " -> " + ench);
			player.sendMessage("[+" + curEnchant + " " + KorNameUtil.getName(itemName, "]이", "]가") + " [+" + ench + " " + KorNameUtil.getName(itemName, "]으로", "]로") + " 강화되었습니다.");
		}
	}
