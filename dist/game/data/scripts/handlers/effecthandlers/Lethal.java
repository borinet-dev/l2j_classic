...
public class Lethal extends AbstractEffect
{
	...
	public void instant(Creature effector, Creature effected, Skill skill, Item item)
	{
		...
		if (Rnd.get(100) < effected.getStat().getValue(Stat.INSTANT_KILL_RESIST, 0))
		{
			...
			effected.sendMessage(effector.getName() + "님의  즉사/반즉사 공격을 회피하였습니다!");
			...
			effector.sendMessage(skill.getName() + "의 즉사/반즉사 공격이 빗나갔습니다.");
		}
		// Half-Kill
		...
		else if (Rnd.get(100) < (_fullLethal * chanceMultiplier))
		{
			...
			if (effected.isPlayer())
			{
				...
				effected.sendPacket(SystemMessageId.HIT_WITH_LETHAL_STRIKE);
			}
			...
			effector.sendPacket(SystemMessageId.LETHAL_STRIKE);
		}
