...
import handlers.bypasshandlers.Captcha;
import handlers.bypasshandlers.ChangePlayerName;
import handlers.bypasshandlers.ChangeVisualRace;
import handlers.bypasshandlers.ChatLink;
import handlers.bypasshandlers.ChoiceItems;
import handlers.bypasshandlers.ClanWarehouse;
import handlers.bypasshandlers.CollectionBypassHandler;
import handlers.bypasshandlers.Cupon;
...
import handlers.bypasshandlers.QuestTeleport;
...
import handlers.communityboard.borinet.Homepage;
import handlers.communityboard.borinet.LunaShop;
import handlers.communityboard.borinet.RankingBoard;
...
import handlers.itemhandlers.ItemDays;
...
import handlers.itemhandlers.PlayYut;
import handlers.itemhandlers.Recipes;
import handlers.itemhandlers.RollingDice;
import handlers.itemhandlers.SayhaPotions;
...
import handlers.voicedcommandhandlers.AutoFollow;
import handlers.voicedcommandhandlers.AutoPlay;
import handlers.voicedcommandhandlers.AutoUseItem;
import handlers.voicedcommandhandlers.Banking;
import handlers.voicedcommandhandlers.ChangeClanName;
import handlers.voicedcommandhandlers.ChangeName;
import handlers.voicedcommandhandlers.ChangePassword;
import handlers.voicedcommandhandlers.ChangeSexual;
import handlers.voicedcommandhandlers.ChangeVisualRaceCommand;
import handlers.voicedcommandhandlers.CharRepair;
import handlers.voicedcommandhandlers.ChatAdmin;
import handlers.voicedcommandhandlers.Command;
import handlers.voicedcommandhandlers.DropSearchCommand;
import handlers.voicedcommandhandlers.EpicBossStatus;
import handlers.voicedcommandhandlers.ExpandInventory;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] HANDLERS =
	{
		...
		},
		{
			...
			ChangeVisualRace.class,
			ChatLink.class,
			ClanWarehouse.class,
			CollectionBypassHandler.class,
			Cupon.class,
			EnsoulWindow.class,
			FindPvP.class,
			Freight.class,
		...
		},
		{
			...
			ChangeClanName.class,
			ChangeName.class,
			Config.ALLOW_CHANGE_PASSWORD ? ChangePassword.class : null,
			ChangeSexual.class,
			ChangeVisualRaceCommand.class,
			CharRepair.class,
			Config.CHAT_ADMIN ? ChatAdmin.class : null,
			Command.class,
			DropSearchCommand.class,
			EpicBossStatus.class,
			ExpandInventory.class,
	...
	public static void main(String[] args)
	{
		...
		LOGGER.info("MasterHandler - 로드 완료.");
	}
}
