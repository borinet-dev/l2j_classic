...
public class CastleTeleporter extends AbstractNpcAI
{
	...
	public String onFirstTalk(Npc npc, Player player)
	{
		...
		if (CommonUtil.contains(MASS_TELEPORTERS, npc.getId()))
		{
			...
			htmltext = npc.isScriptValue(0) ? (siege.isInProgress() && (siege.getControlTowerCount() == 0)) ? "CastleTeleporter-05.html" : "CastleTeleporter-04.html" : "CastleTeleporter-08.html";
		}
