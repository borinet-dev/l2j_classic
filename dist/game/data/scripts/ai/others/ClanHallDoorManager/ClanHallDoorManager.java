...
public class ClanHallDoorManager extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (clanHall != null)
		{
			switch (action)
			{
				...
				case "manageDoors":
				{
					if (isClanMember(player, npc) && st.hasMoreTokens() && player.hasClanPrivilege(ClanPrivilege.CH_OPEN_DOOR))
					{
	...
	public String onFirstTalk(Npc npc, Player player)
	{
		...
		{
			player.sendMessage("이 아지트는 사용할 수 없습니다.");
		}
		return htmltext;
	}
	
	private boolean isClanMember(Player player, Npc npc)
	{
