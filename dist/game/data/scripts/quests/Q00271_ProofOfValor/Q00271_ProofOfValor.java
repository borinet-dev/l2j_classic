...
public class Q00271_ProofOfValor extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		switch (qs.getState())
		{
			case State.CREATED:
			{
				htmltext = (player.getOriginRace() == Race.ORC) ? (player.getLevel() >= MIN_LEVEL) ? (hasAtLeastOneQuestItem(player, NECKLACE_OF_VALOR)) ? "30577-07.htm" : "30577-03.htm" : "30577-02.htm" : "30577-01.htm";
				break;
			}
			case State.STARTED:
			{
