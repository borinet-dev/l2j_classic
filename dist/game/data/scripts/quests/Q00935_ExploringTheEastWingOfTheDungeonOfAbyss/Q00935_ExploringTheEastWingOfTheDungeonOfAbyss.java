	...
	public String onTalk(Npc npc, Player talker)
	{
		...
		switch (qs.getState())
		{
			case State.CREATED:
			{
				if (npc.getId() == IRIS)
				{
					htmltext = ((talker.getLevel() < 45) || (talker.getLevel() > 49)) ? "nolvl.htm" : "31776-01.htm";
				}
				else if (npc.getId() == ROSAMMY)
				{
					htmltext = ((talker.getLevel() < 45) || (talker.getLevel() > 49)) ? "nolvl.htm" : "31777-01.htm";
				}
				break;
			}
			case State.STARTED:
			{
				if (npc.getId() == IRIS)
				{
					switch (qs.getCond())
					{
						case 0:
						{
							if ((qs.getPlayer().getLevel() > 45) && (qs.getPlayer().getLevel() < 50))
							{
						...
						case 1:
						{
							htmltext = "31776-02.htm";
							break;
						}
						case 2:
						{
							htmltext = "31776-03.htm";
							break;
						}
					}
					break;
				...
				else if (npc.getId() == ROSAMMY)
				{
					switch (qs.getCond())
					{
						...
						case 1:
						{
							htmltext = "31777-02.htm";
							break;
						}
						case 2:
						{
							htmltext = "31777-03.htm";
							break;
						}
					}
				}
			...
			case State.COMPLETED:
			{
				if (qs.isNowAvailable())
				{
					...
					if ((npc.getId() == IRIS) && (qs.getPlayer().getLevel() < 50))
					{
						htmltext = "31776-01.htm";
					}
					else if ((npc.getId() == ROSAMMY) && (qs.getPlayer().getLevel() < 50))
					{
						htmltext = "31777-01.htm";
					}
					else
