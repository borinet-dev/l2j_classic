...
public class Q00348_AnArrogantSearch extends Quest
{
	...
	private static final int TABLET_OF_VISION = 31646;
	// Monsters
	...
	public Q00348_AnArrogantSearch()
	{
		...
		addTalkId(HANELLIN, CLAUDIA_ATHEBALT, TABLET_OF_VISION);
	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		if (qs != null)
		{
			switch (npc.getId())
			{
				...
				case SEAL_ANGEL:
				{
					if (qs.isCond(9) && giveItemRandomly(killer, npc, WHITE_CLOTH_ANGLE, 1, 100, 0.5, true))
					{
						qs.setCond(11);
					}
					break;
