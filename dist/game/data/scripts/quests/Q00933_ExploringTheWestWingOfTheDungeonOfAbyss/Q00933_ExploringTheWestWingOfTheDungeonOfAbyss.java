	...
	public String onTalk(Npc npc, Player talker)
	{
		...
		switch (qs.getState())
		{
			case State.CREATED:
			{
				if (npc.getId() == MAGRIT)
				{
					htmltext = ((talker.getLevel() < 40) || (talker.getLevel() > 46)) ? "nolvl.htm" : "31774-01.htm";
				}
				else if (npc.getId() == INGRIT)
				{
					htmltext = ((talker.getLevel() < 40) || (talker.getLevel() > 46)) ? "nolvl.htm" : "31775-01.htm";
				}
				break;
			}
			case State.STARTED:
			{
				if (npc.getId() == MAGRIT)
				{
					switch (qs.getCond())
					{
						case 0:
						{
							if ((qs.getPlayer().getLevel() > 39) && (qs.getPlayer().getLevel() < 47))
							{
						...
						case 1:
						{
							htmltext = "31774-02.htm";
							break;
						}
						case 2:
						{
							htmltext = "31774-03.htm";
							break;
						}
					}
					break;
				...
				else if (npc.getId() == INGRIT)
				{
					switch (qs.getCond())
					{
						...
						case 1:
						{
							htmltext = "31775-02.htm";
							break;
						}
						case 2:
						{
							htmltext = "31775-03.htm";
							break;
						}
					}
				}
			...
			case State.COMPLETED:
			{
				if (qs.isNowAvailable())
				{
					...
					if ((npc.getId() == MAGRIT) && (qs.getPlayer().getLevel() < 47))
					{
						htmltext = "31774-01.htm";
					}
					else if ((npc.getId() == INGRIT) && (qs.getPlayer().getLevel() < 47))
					{
						htmltext = "31775-01.htm";
					}
					else
